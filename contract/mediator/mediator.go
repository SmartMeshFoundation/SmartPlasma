...
const MediatorABI = "[{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"checkToken\",\"outputs\":[{\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"name\":\"_newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"constructor\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"previousOwner\",\"type\":\"address\"}],\"name\":\"OwnershipRenounced\",\"type\":\"event\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]"

// MediatorBin is the compiled bytecode used for deploying new contracts.
const MediatorBin = ``
...
func DeployMediator(auth *bind.TransactOpts, backend bind.ContractBackend) (common.Address, *types.Transaction, *Mediator, error) {
	...
	return address, tx, &Mediator{MediatorCaller: MediatorCaller{contract: contract}, MediatorTransactor: MediatorTransactor{contract: contract}, MediatorFilterer: MediatorFilterer{contract: contract}}, nil
}
...
type Mediator struct {
	...
	MediatorFilterer   // Log filterer for contract events
}
...
// MediatorFilterer is an auto generated log filtering Go binding around an Ethereum contract events.
type MediatorFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}
...
func NewMediator(address common.Address, backend bind.ContractBackend) (*Mediator, error) {
	contract, err := bindMediator(address, backend, backend, backend)
	if err != nil {
		return nil, err
	}
	return &Mediator{MediatorCaller: MediatorCaller{contract: contract}, MediatorTransactor: MediatorTransactor{contract: contract}, MediatorFilterer: MediatorFilterer{contract: contract}}, nil
}
...
func NewMediatorCaller(address common.Address, caller bind.ContractCaller) (*MediatorCaller, error) {
	contract, err := bindMediator(address, caller, nil, nil)
	if err != nil {
		return nil, err
	}
...
func NewMediatorTransactor(address common.Address, transactor bind.ContractTransactor) (*MediatorTransactor, error) {
	contract, err := bindMediator(address, nil, transactor, nil)
	if err != nil {
		return nil, err
	}
...
// NewMediatorFilterer creates a new log filterer instance of Mediator, bound to a specific deployed contract.
func NewMediatorFilterer(address common.Address, filterer bind.ContractFilterer) (*MediatorFilterer, error) {
	contract, err := bindMediator(address, nil, nil, filterer)
	if err != nil {
		return nil, err
	}
	return &MediatorFilterer{contract: contract}, nil
}

// bindMediator binds a generic wrapper to an already deployed contract.
func bindMediator(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(MediatorABI))
	if err != nil {
		return nil, err
	}
...
// returns.
func (_Mediator *MediatorRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Mediator.Contract.MediatorCaller.contract.Call(opts, result, method, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_Mediator *MediatorCallerRaw) Call(opts *bind.CallOpts, result interface{}, method string, params ...interface{}) error {
	return _Mediator.Contract.contract.Call(opts, result, method, params...)
}
...
func (_Mediator *MediatorCaller) CheckToken(opts *bind.CallOpts, addr common.Address) (bool, error) {
	var (
		ret0 = new(bool)
	)
	out := ret0
	err := _Mediator.contract.Call(opts, out, "checkToken", addr)
	return *ret0, err
}
...
func (_Mediator *MediatorCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Mediator.contract.Call(opts, out, "owner")
	return *ret0, err
}
...
// MediatorOwnershipRenouncedIterator is returned from FilterOwnershipRenounced and is used to iterate over the raw logs and unpacked data for OwnershipRenounced events raised by the Mediator contract.
type MediatorOwnershipRenouncedIterator struct {
	Event *MediatorOwnershipRenounced // Event containing the contract specifics and raw log
...
func (it *MediatorOwnershipRenouncedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MediatorOwnershipRenounced)
...
func (it *MediatorOwnershipRenouncedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MediatorOwnershipRenouncedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MediatorOwnershipRenounced represents a OwnershipRenounced event raised by the Mediator contract.
type MediatorOwnershipRenounced struct {
...
func (_Mediator *MediatorFilterer) FilterOwnershipRenounced(opts *bind.FilterOpts, previousOwner []common.Address) (*MediatorOwnershipRenouncedIterator, error) {
	...
	logs, sub, err := _Mediator.contract.FilterLogs(opts, "OwnershipRenounced", previousOwnerRule)
	if err != nil {
		return nil, err
	}
	return &MediatorOwnershipRenouncedIterator{contract: _Mediator.contract, event: "OwnershipRenounced", logs: logs, sub: sub}, nil
}

// WatchOwnershipRenounced is a free log subscription operation binding the contract event 0xf8df31144d9c2f0f6b59d69b8b98abd5459d07f2742c4df920b25aae33c64820.
//
// Solidity: e OwnershipRenounced(previousOwner indexed address)
func (_Mediator *MediatorFilterer) WatchOwnershipRenounced(opts *bind.WatchOpts, sink chan<- *MediatorOwnershipRenounced, previousOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mediator.contract.WatchLogs(opts, "OwnershipRenounced", previousOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(MediatorOwnershipRenounced)
				if err := _Mediator.contract.UnpackLog(event, "OwnershipRenounced", log); err != nil {
					return err
				}
				event.Raw = log
...
// MediatorOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Mediator contract.
type MediatorOwnershipTransferredIterator struct {
	Event *MediatorOwnershipTransferred // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *MediatorOwnershipTransferredIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(MediatorOwnershipTransferred)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *MediatorOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *MediatorOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// MediatorOwnershipTransferred represents a OwnershipTransferred event raised by the Mediator contract.
type MediatorOwnershipTransferred struct {
	PreviousOwner common.Address
...
func (_Mediator *MediatorFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*MediatorOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Mediator.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &MediatorOwnershipTransferredIterator{contract: _Mediator.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: e OwnershipTransferred(previousOwner indexed address, newOwner indexed address)
func (_Mediator *MediatorFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *MediatorOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Mediator.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(MediatorOwnershipTransferred)
				if err := _Mediator.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
const RootChainABI = "[{\"constant\":false,\"inputs\":[{\"name\":\"currency\",\"type\":\"address\"},{\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"deposit\",\"outputs\":[],\"payable\":true,\"stateMutability\":\"payable\",\"type\":\"function\"}]"
...
func (_RootChain *RootChainTransactor) Deposit(opts *bind.TransactOpts, currency common.Address, amount *big.Int) (*types.Transaction, error) {
	return _RootChain.contract.Transact(opts, "deposit", currency, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(currency address, amount uint256) returns()
func (_RootChain *RootChainSession) Deposit(currency common.Address, amount *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.Deposit(&_RootChain.TransactOpts, currency, amount)
}

// Deposit is a paid mutator transaction binding the contract method 0x47e7ef24.
//
// Solidity: function deposit(currency address, amount uint256) returns()
func (_RootChain *RootChainTransactorSession) Deposit(currency common.Address, amount *big.Int) (*types.Transaction, error) {
	return _RootChain.Contract.Deposit(&_RootChain.TransactOpts, currency, amount)
}
